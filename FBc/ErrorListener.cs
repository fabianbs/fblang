...
namespace FBc {
    ...
    class ErrorListener<T> : Antlr4.Runtime.IAntlrErrorListener<T> {
        ...
        /// <inheritdoc />
        public void SyntaxError(TextWriter output, IRecognizer recognizer, T offendingSymbol, int line,
                                int charPositionInLine,
                                string msg, RecognitionException e) {
            msg.Report(new Position(fileName, line, charPositionInLine));
        }
